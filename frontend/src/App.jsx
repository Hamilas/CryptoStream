    ...
    <div style={{ minHeight: '100vh', background: '#0a0f1a', color: '#f1f5f9', fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <footer style={{
        ...
        <span style={{ fontSize: 12, color: '#475569' }}>
          Built by{' '}
          <a href="https://github.com/Hamilas" target="_blank" rel="noreferrer" style={{ color: '#60a5fa' }}>Rayen Lassoued</a>
          {' · '}
          <a href="https://www.linkedin.com/in/lassoued-rayen/" target="_blank" rel="noreferrer" style={{ color: '#60a5fa' }}>LinkedIn</a>
        </span>
      </footer>
    </div>
  )
